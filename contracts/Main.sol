//TODO:replace requestedById/Name with msg.sender, Another mapping for authmans by sender
...
contract Main
{
  ...
  //key:counter
  mapping(bytes32 => Authman) authmanByAuthmanIdHash;
  //key:claimHash
  mapping(bytes32 => Authman) authmanByClaimHash;
  ...
  function createOrUpdateAuthmanGuid(string firstName, 
    ...
    function createOrUpdateAuthmanGuid(
      ...
      createOrUpdateAuthmanGuid(firstName, 
        lastName, 
        ssn, 
        dob, 
        pin, 
    ...
    function claimAuthmanId(
      ...
      if (authmanByAuthmanIdHash[authmanIdHash].guid[0] != 0) {
        AnyException("Authman Id already in use. Try new authman Id.");
        return;
      }

      Authman memory authman = authmanByClaimHash[claimHash];
      ...
      if (authman.isClaimed) {
        AnyException("Authman is already claimed.");
        return;
      }
